...
class WatcherApp(ttk.Frame):
    ...
    def _build(self):
        ...
        self.status = ttk.Label(
            self, text="Mode: Sur | Backend: ollama | Modèle: llama3.2:3b"
        )
        self.status.pack(fill="x")

        # Briefing bouton
        ttk.Button(
            self.brief, text="Démarrer le Briefing", command=self._brief
        ...
        ttk.Button(
            at, text="Améliorer (A/B)", command=self._improve
